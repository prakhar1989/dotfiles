...
if has("gui_running")
  "GUI Colors
  highlight Normal guifg=White   guibg=#030408
  highlight Cursor guifg=Black   guibg=Yellow
  highlight CursorLine guibg=#191E2F
  highlight LineNr guibg=#070a15 guifg=#888888
  ...
  highlight Constant guifg=#D8FA3C gui=italic
  ...
  highlight htmlH1 guifg=#b294bb  guibg=NONE gui=bold
  highlight htmlH2 guifg=#b294bb  guibg=NONE gui=bold
  highlight htmlH3 guifg=#b294bb  guibg=NONE gui=bold
  highlight htmlH4 guifg=#b294bb  guibg=NONE gui=bold
  highlight htmlH5 guifg=#b294bb  guibg=NONE gui=bold
  highlight htmlH6 guifg=#b294bb  guibg=NONE gui=bold
  ...
  "Python colors
  highlight pythonClassName guifg=#ffa724 guibg=NONE gui=bold
  highlight pythonFuncName guifg=#ffa724 guibg=NONE
  highlight pythonPreCondit guifg=#cc6666 guibg=NONE
  highlight pythonStatement guifg=#81a2be guibg=NONE
  highlight pythonAssignment guifg=#b294bb guibg=NONE
  highlight pythonParamName guifg=#81a2be guibg=NONE
end
